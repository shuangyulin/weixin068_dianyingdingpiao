...
import center from '@/views/center'
    import discussyingyuanxinxi from '@/views/modules/discussyingyuanxinxi/list'
    import yingyuanxinxi from '@/views/modules/yingyuanxinxi/list'
...
const routes = [{
    ...
    children: [{
      ...
      ,{
	path: '/discussyingyuanxinxi',
        name: '影院信息评论',
        component: discussyingyuanxinxi
      }
      ,{
	path: '/yingyuanxinxi',
        name: '影院信息',
        component: yingyuanxinxi
      }
      ,{
	path: '/news',
        name: '电影资讯',
